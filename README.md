...
```
$ go install github.com/AiRISTAFlowInc/flow-studio-cli/...@latest
```
...
$ git clone https://github.com/AiRISTAFlowInc/flow-studio-cli.git
...
- flogo cli: [kind/help-wanted](https://github.com/AiRISTAFlowInc/flow-studio-cli/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22) and [good first issue](https://github.com/AiRISTAFlowInc/flow-studio-cli/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
...
Flogo source code in [this](https://github.com/AiRISTAFlowInc/flow-studio-cli) repository is under a BSD-style license, refer to [LICENSE](https://github.com/AiRISTAFlowInc/flow-studio-cli/blob/master/LICENSE)
